...
public class MainActivity extends Activity {
	...
	// detect if the device is Nook and save it for later use
	protected void onCreate(Bundle savedInstanceState) {
		String manufacturer = System.getProperty("ro.nook.manufacturer");
		String brand = Build.BRAND;
		isNook = ((brand != null && brand.equalsIgnoreCase("nook")) ||
							 manufacturer != null && manufacturer.equalsIgnoreCase("nook")) ? true : false;
		Wallet.saveBrand(isNook);
	}
		...
		public void onClick(View arg0) {
				...
				{ 	
					...
					if Wallet.spendPoints(1)
					{
						...
						// Update the Points displayed on UI
					}
					else
					{
